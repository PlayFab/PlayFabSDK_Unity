...
namespace PartyCSharpSDK.Interop
{
    partial class PFPInterop
    {
        ...
        const string ThunkDllName = "PartyGDK";
        ...
        //PartyInitialize(
        //    const PARTY_INITIALIZATION_CONFIGURATION* initArgs,
        //    _Outptr_ PARTY_HANDLE* handle
        //    );
        [DllImport(ThunkDllName, CallingConvention = CallingConvention.StdCall)]
        internal unsafe static extern UInt32 PartyInitialize(
            PARTY_INITIALIZATION_CONFIGURATION* initArgs,
        ...
        //    );
        [DllImport(ThunkDllName, CallingConvention = CallingConvention.StdCall)]
        internal unsafe static extern UInt32 PartyCreateLocalUser(
            PARTY_HANDLE handle,
            PFEntityHandle entityId,
