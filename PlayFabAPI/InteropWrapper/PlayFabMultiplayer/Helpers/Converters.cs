namespace PlayFab.InteropWrapper.Multiplayer
{
    ...
    public static class Converters
    {
            ...
            DisposableCollection disposableCollection)
        {
            ...
            PlayFab.Multiplayer.DisposableBuffer buffer = disposableCollection.Add(new PlayFab.Multiplayer.DisposableBuffer(checked(sizeOfStruct)));
            ...
            out SizeT arrayCount)
        {
            ...
            bool isEnum = typeof(InteropStructType).IsEnum;
            int sizeOfStruct = Marshal.SizeOf(isEnum ? Enum.GetUnderlyingType(typeof(InteropStructType)) : typeof(InteropStructType));
            PlayFab.Multiplayer.DisposableBuffer buffer = disposableCollection.Add(new PlayFab.Multiplayer.DisposableBuffer(checked(sizeOfStruct * inputTypes.Length)));
        ...
        internal static PlayFab.Multiplayer.DisposableBuffer StringArrayToUTF8StringArray(string[] strings)
        {
            if (strings == null)
            {
                return new PlayFab.Multiplayer.DisposableBuffer();
            }
            ...
            PlayFab.Multiplayer.DisposableBuffer result = new PlayFab.Multiplayer.DisposableBuffer(size);
