namespace PlayFab.Interop.Multiplayer
{
    ...
    internal struct PFLobbyStateChangeUnion
    {
        ...
        [FieldOffset(0)]
        internal readonly PFLobbyJoinLobbyAsServerCompletedStateChange joinLobbyAsServerCompleted;
        [FieldOffset(0)]
        internal readonly PFLobbyServerPostUpdateAsServerCompletedStateChange serverPostUpdateAsServerCompleted;
        [FieldOffset(0)]
        internal readonly PFLobbyServerLeaveLobbyAsServerCompletedStateChange serverLeaveLobbyAsServerCompleted;
    }
}
